...
public class Statistics_HashTags {
    ...
    public static class TokenizerMapper extends Mapper<Object, Text, Text, LongWritable>{
        ...
        public void map(Object key, Text row, Context context) throws IOException, InterruptedException {
            ...
            if (!stringArray[10].equals("null;")) {
                for (String word : stringArray[10].split(" ")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, Statistics_HashTags.class.getName());

        job.setJarByClass(Statistics_HashTags.class);
