...
public class Statistics_Usernames {
    ...
    public static class TokenizerMapper extends Mapper<Object, Text, Text, LongWritable>{
        ...
        public void map(Object key, Text row, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(stringArray[1]), one);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, Statistics_Usernames.class.getName());

        job.setJarByClass(Statistics_Usernames.class);
